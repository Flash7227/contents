{{-- <footer class="footer bg-primary footer-color">
    ...
    <div class="row">
        <div class="col-md-4 col-sm-4">
            <div class="f_glass f_url">
                <h3 >Холбоос</h3>
                <li>
                    <a href="https://crc.gov.mn/" class="footer-color">Байгууллагын веб хуудас</a>
                </li>
                <li>
                    <a href="http://www.black-list.mn//" class="footer-color">Шуудангийн нэгдсэн кодын систем</a>
                </li>
                <li>
                    <a href="https://zipcode.mn/" class="footer-color">Зөрчилтэй домайны жагсаалт</a>
                </li>
            </div>
        </div>
        <div class="col-md-2 col-sm-2">
            <div class="f_glass">
                <h3>Сошиал</h3>
                <button type="button" class="btn btn-primary" onclick="location.href='http://www.facebook.com/crcmongol'">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                     <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"></path>
                    </svg>
                </button>
                <button type="button" class="btn btn-outline-warning" onclick="location.href='http://www.twitter.com/crcmn'">
        ...
        <div class="col-md-6 col-sm-6">
            <div class="f_glass f_url">
                ...
                <li>
                     <a href="mailto:info@crc.gov.mn" class="footer-color">info@crc.gov.mn</a>
                </li>
            </div>
        </div>
    ...
    <div class="container d-flex flex-column flex-sm-row justify-content-between py-4 border-top">
